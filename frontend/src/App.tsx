...
function App() {
  ...
  return <main>
    ...
    <footer><span>Source: Ontario AMIS hazard features and PDEM terrain, processed for the configured Cobalt study window. Data shown here is a static export, not a live hazard service.</span><a href="https://github.com/ammar-15" target="_blank" rel="noreferrer">github.com/ammar-15</a></footer>
